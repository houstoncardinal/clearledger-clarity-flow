...
import { CheckCircle, ArrowRight, Phone, Flame, DollarSign, Shield, Clock, BarChart3 } from 'lucide-react';
...
const EnergyBookkeeping = () => {
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      { "@type": "Question", "name": "Do you handle joint interest billing for oil and gas companies?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, ClearLedger processes JIBs for operators, properly allocating costs among working interest owners and managing partner billing for multiple wells and leases." } },
      ...
      { "@type": "Question", "name": "Do you handle Texas severance tax for energy companies?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, we calculate and track Texas oil and gas severance taxes, ensure timely filings with the Texas Comptroller, and maintain proper documentation." } }
    ]
  };

  const pageSchema = combineSchemas(
    getProfessionalServiceSchema({ name: "Energy & Oil Company Bookkeeping Dallas TX", description: "Revenue interest tracking, JIB processing, and oil & gas accounting in Dallas TX.", url: "/energy-bookkeeping", category: "Energy Bookkeeping" }),
  ...
  return (
    <>
      <SEO title="Energy & Oil Company Bookkeeping Dallas TX | JIB & Revenue Tracking | ClearLedger" description="Expert energy bookkeeping in Dallas TX. Revenue interest tracking, JIB processing, depletion schedules, severance tax & regulatory compliance. Call (903) 815-9488." keywords="energy bookkeeping Dallas TX, oil gas accounting, JIB processing, revenue interest tracking, oil company bookkeeper Texas, petrochemical accounting, severance tax" canonical="/energy-bookkeeping" schema={pageSchema} />
      <Header />
      <main className="min-h-screen bg-background">
        <section className="pt-20 sm:pt-24 lg:pt-28 pb-12 sm:pb-16 bg-gradient-to-br from-background via-accent/10 to-background">
          <div className="container mx-auto px-4 sm:px-6"><div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">Dallas TX{' '}<span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-dark">Energy & Oil Bookkeeping</span>{' '}Experts</h1>
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed mb-8 max-w-3xl mx-auto">From revenue interest tracking to JIB processing, ClearLedger provides specialized accounting for energy companies across Texas.</p>
