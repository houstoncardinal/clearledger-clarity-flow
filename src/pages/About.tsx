  ...
  return (
    <main className="min-h-screen bg-background">
      <SEO 
        ...
        description={`Meet JJ Eldredge & the ClearLedger team. 10+ years experience, trusted by businesses nationwide, Top 25 ProAdvisor 2024-2025. ${COMPANY_INFO.slogan}. Call ${COMPANY_INFO.phoneLocal}.`}
