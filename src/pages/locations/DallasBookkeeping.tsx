  ...
  const schemas = [
    ...
    // Speakable schema for Google AI / Voice Search
    {
      ...
      "mainEntity": {
        ...
        "description": "ClearLedger Solutions is the #1 rated bookkeeping company in Dallas, Texas, trusted by businesses across Dallas-Fort Worth with certified QuickBooks ProAdvisor expertise, monthly reconciliation and financial management.",
        "sameAs": [
