...
const TexasBookkeeping = () => {
  const breadcrumbs = [
    ...
    { name: "Texas Bookkeeping", url: "/texas-bookkeeping" }
  ];
  ...
  return (
    <>
      <SEO 
        title="Texas Bookkeeping Services | ClearLedger Solutions - Dallas, Houston, Austin"
        description="Professional bookkeeping services for Texas businesses. Expert QuickBooks management, Texas franchise tax compliance, and financial reporting for Dallas, Houston, Austin, and statewide."
        keywords="Texas bookkeeping, Dallas bookkeeper, Houston bookkeeping services, Austin bookkeeper, QuickBooks Texas, Texas franchise tax, small business bookkeeping TX"
        canonical="/texas-bookkeeping"
        schema={[
          getServiceSchema("Texas Bookkeeping Services", "Professional bookkeeping and financial management services for Texas businesses including QuickBooks management, franchise tax compliance, and payroll processing."),
      ...
      <main className="min-h-screen bg-background">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="text-left">
                  ...
                  <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed mb-8 max-w-2xl">
                    Serving the Lone Star State with comprehensive bookkeeping, QuickBooks expertise, 
                    and Texas franchise tax compliance from our North Texas base.
                  </p>

                  <div className="grid grid-cols-2 gap-4 mb-8">
                    <div className="flex items-center space-x-3">
                      <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                      <span className="text-sm font-medium text-foreground">Franchise Tax Experts</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                      <span className="text-sm font-medium text-foreground">All Major Cities</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                    ...
                    <div className="flex items-center space-x-3">
                      <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                      <span className="text-sm font-medium text-foreground">Same-Day Support</span>
                    </div>
                  </div>
                ...
                <div className="relative">
                  <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-3xl p-8 border border-primary/20">
                    <h3 className="font-heading text-xl font-bold text-foreground mb-4">Texas Cities We Serve</h3>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="font-heading text-3xl lg:text-4xl font-bold text-foreground mb-4">
                Complete Bookkeeping Services for Texas Businesses
              </h2>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                From startups to established enterprises, we provide comprehensive financial management 
                tailored to Texas's thriving economy.
              </p>
            </div>
        ...
        <section className="py-16 bg-gradient-subtle">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                We understand the unique financial needs of Texas's diverse economy.
              </p>
            </div>
              ...
              <div className="bg-card rounded-2xl p-8 shadow-premium">
                <div className="text-center mb-8">
                  ...
                  <p className="text-muted-foreground">
                    We ensure your business stays compliant with Texas franchise tax requirements.
                  </p>
                </div>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                      <span className="text-foreground">Annual report preparation</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                      <span className="text-foreground">Margin calculation optimization</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                      <span className="text-foreground">Filing deadline management</span>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                      <span className="text-foreground">EZ computation eligibility review</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                      <span className="text-foreground">Multi-state apportionment</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <CheckCircle className="w-5 h-5 text-primary flex-shrink-0" />
                      <span className="text-foreground">Extension filing assistance</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 bg-gradient-subtle">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="font-heading text-3xl lg:text-4xl font-bold text-foreground mb-4">
                Why Texas Businesses Choose ClearLedger
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-6 bg-card rounded-xl shadow-card">
                ...
                <h3 className="font-heading text-lg font-bold text-foreground mb-2">Texas-Based</h3>
                <p className="text-sm text-muted-foreground">Local team with deep Texas business knowledge</p>
              </div>
              <div className="text-center p-6 bg-card rounded-xl shadow-card">
              ...
              <div className="text-center p-6 bg-card rounded-xl shadow-card">
                ...
                <p className="text-sm text-muted-foreground">Strategic insights for Texas business growth</p>
              </div>
              <div className="text-center p-6 bg-card rounded-xl shadow-card">
          ...
          <div className="container mx-auto px-4">
            <div className="bg-card rounded-2xl p-8 shadow-premium text-center">
              ...
              <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">
                Join thousands of Texas businesses who trust ClearLedger for their bookkeeping needs.
              </p>
