...
const Index = () => {
  ...
  return (
    <main className="min-h-screen bg-background">
      <SEO 
        title="Best Bookkeeping Company in Dallas TX | QuickBooks ProAdvisor | ClearLedger"
        description={`ClearLedger Solutions — best bookkeeping company in Dallas, Texas. Award-winning QuickBooks ProAdvisor. Bookkeeping Dallas, tax prep & financial reporting for businesses of all sizes. Call ${COMPANY_INFO.phoneLocal}.`}
        keywords="best bookkeeping company in dallas, bookkeeping dallas, bookkeeping company in dallas tx, best bookkeeping company in dallas texas, top bookkeeping company dallas, dallas bookkeeping services, bookkeeper dallas tx, QuickBooks ProAdvisor Dallas, small business bookkeeping Dallas TX, ClearLedger Solutions"
        canonical="/"
