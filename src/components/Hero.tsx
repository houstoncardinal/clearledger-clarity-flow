...
import heroBookkeeper from '@/assets/hero-bookkeeper.jpg';
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="relative">
                {/* Glow */}
                <div className="absolute -inset-6 bg-gradient-to-br from-primary/20 via-transparent to-purple-500/20 rounded-[2rem] blur-3xl opacity-60" />

                {/* Image card */}
                <div className="relative rounded-[1.5rem] overflow-hidden shadow-2xl border border-border/40">
                  <img
                    src={heroBookkeeper}
                    alt="ClearLedger certified bookkeeper reviewing financial dashboards for a small business client"
                    width={1024}
                    height={1280}
                  ...
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-6">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <div className="text-white font-semibold text-sm">Top 25 ProAdvisor</div>
                        <div className="text-white/80 text-xs">2024 & 2025 — Insightful Accountant</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-2 mt-3 text-white/90 text-xs">
                  ...
                  <div className="absolute top-4 right-4 px-3 py-1.5 rounded-full bg-white/95 backdrop-blur-sm shadow-lg flex items-center gap-1.5">
                    <Shield className="w-4 h-4 text-primary" />
                    <span className="text-xs font-semibold text-foreground">Trusted Nationwide</span>
                  </div>
                </div>
              </div>
            </motion.div>
