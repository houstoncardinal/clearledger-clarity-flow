          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex justify-center">
              <Link to="/check-ordering">
                <Button 
                  size="lg" 
                  className="group bg-gradient-to-r from-primary via-purple-500 to-primary bg-[length:200%_100%] hover:bg-right text-white font-semibold text-lg px-8 py-6 h-auto rounded-2xl shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-500"
                >
